                                    ...
                                    <div class="col-sm-12 col-md-8 col-lg-6 col-md-offset-2 col-lg-offset-3">
                                        <div class="panel modern-card">
                                            <div class="panel-heading">
                                                ...
                                                &nbsp;&nbsp; <button type="button" class="btn btn-modern" data-toggle="modal" data-target="#studentInsertModal">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form id="importStudentsForm" action="import_students.php" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit" class="btn btn-modern">Import</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="panel-body">
                                                <form method="post">
                                                    ...
                                                    <div class="form-group" style="margin-top:16px;">
                                                        <button type="submit" name="submit" class="btn btn-modern btn-block-sm"><i class="fa fa-save"></i> Save Student</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
