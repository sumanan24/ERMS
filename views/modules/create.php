...
<div class="main-content">
    <div class="form-container">
        <h1 style="margin-bottom: 30px; color: #333;">Create New Module</h1>
        ...
        <form method="POST" action="index.php?action=modules&sub=create" id="moduleForm">
                ...
                <select id="cid" name="cid" required>
                    ...
                    <?php foreach ($courses as $course): ?>
                        <option value="<?php echo $course['id']; ?>" 
                                <?php echo (isset($_POST['cid']) && $_POST['cid'] == $course['id']) ? 'selected' : ''; ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" id="mcode" name="mcode" required 
                       value="<?php echo htmlspecialchars($_POST['mcode'] ?? ''); ?>"
            ...
            <div class="form-group">
                ...
                <input type="number" id="credit" name="credit" step="0.1" min="0" 
                       value="<?php echo htmlspecialchars($_POST['credit'] ?? '0'); ?>"
                       placeholder="e.g., 3.0">
            </div>
